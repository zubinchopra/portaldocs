...
C# based test-fx is fully supported by the Ibiza team. The C# is internally used for testing the Azure Portal (Shell). The C# test framework is available for partners to view the code contribute features and bug fixes. For more information, see [portalfx-extensions-c#-test-framework-overview.md](portalfx-extensions-c#-test-framework-overview.md).

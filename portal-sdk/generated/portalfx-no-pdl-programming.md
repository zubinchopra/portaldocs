* [TypeScript decorator support for extension metadata (formerly known as No-PDL or No PDL)](#typescript-decorator-support-for-extension-metadata-formerly-known-as-no-pdl-or-no-pdl)
    * [Current TypeScript decorator support](#typescript-decorator-support-for-extension-metadata-formerly-known-as-no-pdl-or-no-pdl-current-typescript-decorator-support)
    * [Building a hello world template blade using decorators](#typescript-decorator-support-for-extension-metadata-formerly-known-as-no-pdl-or-no-pdl-building-a-hello-world-template-blade-using-decorators)
    * [Building a menu blade using decorators](#typescript-decorator-support-for-extension-metadata-formerly-known-as-no-pdl-or-no-pdl-building-a-menu-blade-using-decorators)
    * [The context property](#typescript-decorator-support-for-extension-metadata-formerly-known-as-no-pdl-or-no-pdl-the-context-property)

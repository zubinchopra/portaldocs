...
<a name="faq-getting-started-with-visual-studio-coming-soon"></a>
...
<a name="faq-creating-a-project-from-scratch-with-visual-studio-code"></a>
## Creating a project from scratch with Visual Studio Code
...
<a name="faq-creating-a-project-from-scratch-with-visual-studio-code-add-index-html-for-running-tests"></a>
### Add ./index.html for running tests
...
<a name="faq-creating-a-project-from-scratch-with-visual-studio-code-to-generate-fxscriptdependencies-js"></a>
### to generate FxScriptDependencies.js
...
<a name="faq-creating-a-project-from-scratch-with-visual-studio-code-to-generate-fxscriptdependencies-js-add-package-json"></a>
#### Add ./package.json
...
<a name="faq-creating-a-project-from-scratch-with-visual-studio-code-to-generate-fxscriptdependencies-js-add-msportalfx-ut-config-json"></a>
#### add ./msportalfx-ut.config.json
...
<a name="faq-add-a-test-build-your-test-project"></a>
### Build your test project
...
<a name="faq-configure-require-and-mocha-using-add-init-js"></a>
...
<a name="faq-configure-require-and-mocha-using-add-init-js-run-your-tests"></a>
### Run your tests

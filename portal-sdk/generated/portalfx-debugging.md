* [Debugging](#debugging)
    * [Using the Debug Tool](#debugging-using-the-debug-tool)
    * [Toggling optimizations (turn on/off bundling and minification)](#debugging-toggling-optimizations-turn-on-off-bundling-and-minification)
    * [Restore default settings](#debugging-restore-default-settings)
    * [Checking for console errors](#debugging-checking-for-console-errors)
    * [Ensuring your extension is loaded](#debugging-ensuring-your-extension-is-loaded)
    * [Debugging JavaScript](#debugging-debugging-javascript)
    * [Debugging the data stack](#debugging-debugging-the-data-stack)
    * [Debugging Knockout](#debugging-debugging-knockout)
    * [Crossing the iframe boundary](#debugging-crossing-the-iframe-boundary)
    * [Fixing 520 Errors](#debugging-fixing-520-errors)
    * [Debugging in production](#debugging-debugging-in-production)
    * [Getting Help](#debugging-getting-help)
    * [FAQ](#debugging-faq)

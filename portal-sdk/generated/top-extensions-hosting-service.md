...
<a name="overview-how-the-hosting-service-serves-an-extension"></a>
...
<a name="overview-reasons-for-using-the-hosting-service"></a>
...
<a name="overview-hosting-services-and-server-side-code"></a>
...
<a name="overview-hosting-services-and-server-side-code-logging"></a>
#### Logging
...
<a name="overview-hosting-services-and-server-side-code-trace-events"></a>
#### Trace Events
...
<a name="overview-hosting-services-and-server-side-code-telemetry-events"></a>
#### Telemetry Events
...
<a name="overview-hosting-services-and-server-side-code-monitoring"></a>
#### Monitoring
...
<a name="procedures-checklist-for-onboarding-hosting-service"></a>
...
<a name="procedures-checklist-for-onboarding-hosting-service-initial-onboarding-to-the-hosting-service"></a>
...
<a name="procedures-checklist-for-onboarding-hosting-service-update-isdevelopmentmode-flag"></a>
...
<a name="procedures-checklist-for-onboarding-hosting-service-install-contentunbundler"></a>
...
<a name="procedures-checklist-for-onboarding-hosting-service-verify-the-version-number"></a>
...
<a name="procedures-provide-environment-specific-configuration-files"></a>
...
<a name="procedures-provide-environment-specific-configuration-files-overriding-settings"></a>
#### Overriding settings
...
<a name="procedures-provide-environment-specific-configuration-files-loading-in-the-target-environment"></a>
...
1. FairFax 
    ...
    ```
<a name="procedures-provide-environment-specific-configuration-files-execute-content-unbundler-to-generate-zip-file"></a>
...
<a name="procedures-provide-environment-specific-configuration-files-upload-safe-deployment-config"></a>
...
<a name="procedures-provide-environment-specific-configuration-files-register-the-extension"></a>
...
<a name="procedures-provide-environment-specific-configuration-files-converting-from-custom-deployment-to-a-hosting-service"></a>
...
<a name="advanced-topics-ev2-integration-with-hosting-service"></a>
...
<a name="advanced-topics-ev2-integration-with-hosting-service-configuring-contentunbundler-for-ev2-based-deployments"></a>
...
<a name="advanced-topics-ev2-integration-with-hosting-service-what-output-is-generated"></a>
...
<a name="advanced-topics-ev2-integration-with-hosting-service-specify-contentunbundler-bake-time"></a>
...
<a name="advanced-topics-ev2-integration-with-hosting-service-skipping-safe-deployment"></a>
...
<a name="advanced-topics-ev2-integration-with-hosting-service-friendly-name-removal"></a>
...
<a name="advanced-topics-warm-integration-with-hosting-service"></a>
...
For more information, see [top-extensions-hosting-service.md#prerequisites-for-onboarding-hosting-service](top-extensions-hosting-service.md#prerequisites-for-onboarding-hosting-service).

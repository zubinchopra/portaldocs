* [Working with data](#working-with-data)
    * [Master details browse](#working-with-data-master-details-browse)
        * [The MasterDetail Area and DataContext](#working-with-data-master-details-browse-the-masterdetail-area-and-datacontext)
        * [The websites QueryCache and EntityCache](#working-with-data-master-details-browse-the-websites-querycache-and-entitycache)
        * [Implementing the master view](#working-with-data-master-details-browse-implementing-the-master-view)
        * [Implementing the detail view](#working-with-data-master-details-browse-implementing-the-detail-view)
    * [Overview](#working-with-data-overview)
        * [A bird's-eye view of Data](#working-with-data-overview-a-bird-s-eye-view-of-data)
        * [Data contexts](#working-with-data-overview-data-contexts)
        * [Areas](#working-with-data-overview-areas)
        * [Developing a **DataContext** for an area](#working-with-data-overview-developing-a-datacontext-for-an-area)
        * [Data caches](#working-with-data-overview-data-caches)
        * [Data views](#working-with-data-overview-data-views)
        * [Summary](#working-with-data-overview-summary)
        * [Querying for data](#working-with-data-overview-querying-for-data)
    ...
    * [Observable map & filter](#working-with-data-observable-map-filter)
        * [Shaping and filtering data](#working-with-data-observable-map-filter-shaping-and-filtering-data)
        * [Understanding observable map() and mapInto()](#working-with-data-observable-map-filter-understanding-observable-map-and-mapinto)
        * [Using Knockout projections](#working-with-data-observable-map-filter-using-knockout-projections)
        * [Chaining uses of `map` and `filter`](#working-with-data-observable-map-filter-chaining-uses-of-map-and-filter)
        * [Anti-patterns and best practices](#working-with-data-observable-map-filter-anti-patterns-and-best-practices)
    * [Refreshing cached data](#working-with-data-refreshing-cached-data)
        * [Refresh implicitrefresh](#working-with-data-refreshing-cached-data-refresh-implicitrefresh)
    ...
    * [Virtualized data for the grid](#working-with-data-virtualized-data-for-the-grid)
...
<a name="working-with-data-master-details-browse-the-websites-querycache-and-entitycache"></a>
...
<a name="working-with-data-overview-summary"></a>
### Summary
...
- Configuring the data cache
    ## Configuring the data cache
<a name="working-with-data-overview-querying-for-data"></a>
### Querying for data
...
- Shaping data
    ## Data shaping
<a name="working-with-data-observable-map-filter-shaping-and-filtering-data"></a>
...
<a name="working-with-data-refreshing-cached-data-refresh-implicitrefresh"></a>

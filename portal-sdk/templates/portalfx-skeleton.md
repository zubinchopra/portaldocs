...
<!--                         , "file": "../templates/portalfx-<major-area>-overview.md" -->
...
<!--                       ", "file": "../templates/portalfx-<major-area>-<topic>-<subtopic1>.md"  -->
<!--                        , "file": "../templates/portalfx-<major-area>-<topic>-<subtopic2>.md"  -->
...
<!--  optional FYI document, for links that could not be included in the content within the natural flow of the doc 
                          , "file": "../templates/portalfx-<major-area>-<topic>-fyi.md"  -->
{"gitdown": "include-file", "file": "../templates/portalfx-skeleton-fyi.md"}

<!--  required Glossary document. 
                          , "file": "../templates/portalfx-extensions-glossary-<major-area>.md"  -->

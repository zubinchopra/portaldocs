...
- [Dashboard - latest geninue traffic only](http://aka.ms/portalfx/dashboard/extensionperf)
    ...
    - [Query - including test/dev traffic](https://aka.ms/kwe?cluster=azportal.kusto.windows.net&database=AzurePortal&q=H4sIAAAAAAAAA3NPLXGtKEnNK87MzwtILUoLSs3JTEzKzMksqdRITM%2FXME%2FR1DFP0SkpKk3VVODlqlEoz0gtSlVIhelRsLVVUIr0Dw2Kd40IcfUL9vT3i%2Fdz9HVVUuACAI184H9bAAAA)
